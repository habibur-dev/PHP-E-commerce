      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Girls Long T-Shirt</a></h3>
      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Womes Violet T-Shirt</a></h3>
      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Mens Polo T-Shirt</a></h3>
      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Men's Polo T-Shirt</a></h3>
      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Womens Polo T-Shirt</a></h3>
      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Mens Violet T-Shirt</a></h3>
      ...
      <div class="col-sm-4 col-sm-6 single"><!-- col-sm-4 col-sm-6 single Begin -->
        ...
        <div class="product"><!-- product Begin -->
          ...
          <div class="text"><!-- text Begin -->
            ...
            <h3><a href="details.php">Men's Black T-Shirt</a></h3>
